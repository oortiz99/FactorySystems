...
public class Errores implements Parcelable, Serializable {
    ...
    public Errores( String tipus_error) {
    ...
    public static List<Errores> gettipusErrors(){
        List<Errores> tipuserrores =new ArrayList<>();

        tipuserrores.add( new Errores("Error Mecànic"));
        tipuserrores.add( new Errores( "Error de configuració"));
        tipuserrores.add( new Errores( "Error Electric"));
        tipuserrores.add( new Errores( "Error Fatal"));
        return tipuserrores;
    }
