        ...
        <div class="d-flex">
            <div class="container border border-0 p-3" style="background-color: hsl(218, 41%, 15%);height : 42rem;">
                <ul class="nav nav-tabs border border-0" id="myTab" role="tablist">
                    ...
                    <li class="nav-item " role="presentation">
                        <button class="nav-link rounded-3 txt-color" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Planta 02</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-3 txt-color" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Planta 03</button>
                    </li>
                </ul>
                            ...
                            <div class="bg-body-tertiary d-flex flex-column p-3 border rounded-3">
                                ...
                                @foreach ($errors as $error)
                                    <div class="alert alert-danger" role="alert">
                                        <strong>{{$error["descripcio"]}} : </strong>
                                        <span   class="ms-2"><strong>{{$error["tipus"]}}</strong></span>
                                    </div>
                                @endforeach
                            </div>
